    ...
    return (
        <div className="p-8 bg-gray-50 dark:bg-gray-900 min-h-screen">
            <div className="max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded shadow p-8">
                {/* Header */}
                <h1 className="text-3xl font-bold text-center mb-8 text-gray-800 dark:text-gray-100">Generate Your Reports</h1>
                ...
                <div className="mb-8">
                    ...
                    <div className="relative" ref={dropdownRef}>
                        <div
                            ...
                            className="w-full px-4 py-2 border border-blue-400 rounded focus:outline-none focus:border-blue-500 bg-white dark:bg-gray-700 cursor-pointer flex justify-between items-center"
                        >
                            <span className={selectedReport ? 'text-gray-800 dark:text-gray-100' : 'text-gray-600 dark:text-gray-400'}>
                        ...
                        {isDropdownOpen && (
                            <div className="absolute top-full left-0 right-0 mt-0 border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 shadow-lg z-10">
                                <div className="px-4 py-2 text-gray-600 dark:text-gray-400 border-b dark:border-gray-600">-Select Report Type-</div>
                                {reportTypes.map((report) => (
                                    <div
                                        key={report}
                                        onClick={() => handleSelectReport(report)}
                                        className={`px-4 py-2 cursor-pointer ${selectedReport === report
