  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 max-w-xl">
        ...
        <div>
          <label className="block text-sm font-semibold text-gray-700 mb-2">Script Exchange</label>
          <select
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex items-center gap-2 text-sm">
          ...
          <input
            ...
            className="border border-gray-300 rounded px-3 py-1 w-56 focus:outline-none focus:ring-1 focus:ring-blue-500"
          />
        </div>
      </div>

      {/* Table */}
      <div className="w-full bg-white rounded overflow-x-auto mb-4">
      ...
      <div className="flex justify-between items-center text-sm text-gray-600 mb-4">
        ...
        <div className="flex gap-2">
          <button className="px-4 py-2 border border-gray-300 rounded hover:bg-gray-50 text-gray-700">
            Previous
          </button>
          <button className="px-4 py-2 border border-gray-300 rounded hover:bg-gray-50 text-gray-700">
            Next
